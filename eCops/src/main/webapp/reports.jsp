...
<body>
	...
	<div class="container-fluid">
		<h1 class="mainheading m-3 text-center">Complaint Reports</h1>
	</div>
		...
		<table class="table  table-bordered" id="table">
			...
			<tbody>
				...
				try {
					...
					PreparedStatement stmt = con.prepareStatement("select * from complaints where status = 'Completed'");
				...
				<tr>
					...
					<td><a href="reportdetails.jsp?cid=<%=rs.getString("cid")%>">
							<%
